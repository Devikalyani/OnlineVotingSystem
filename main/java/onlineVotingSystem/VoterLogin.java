...
public class VoterLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String voternum = request.getParameter("votingNumber");
        ...
        try {
           ...
           {
        	PreparedStatement preparedStatement2 = con.prepareStatement("select vid,pnumber from voter where voter_card_number = '"+voternum+"'");
            ResultSet rs =   preparedStatement2.executeQuery("select vid,pnumber from voter where voter_card_number = '"+voternum+"'");
            if(rs.next()){
